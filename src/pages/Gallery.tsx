            ...
            <AnimatePresence mode="wait">
                {selectedPost ? (
                    ...
                    >
                        {/* 타이틀 */}
                        <div className="mb-12">
                            <h2 className="text-4xl md:text-5xl font-black mb-4 text-gray-900">갤러리</h2>
                            <p className="text-gray-600">
                                L.E.A.D와 함께했던 수많은 순간들입니다. 총 <span className="text-gray-900 font-bold">{posts.length}개</span>의 게시물이 있습니다.
                            </p>
                        </div>
